...
public class Helper
{
	private static final String keyUserAccount = "USER_ACCOUNT";
	private static final String keyHomeAdUnit = "HOME_AD_UNIT";
	private static final String keySuccessImpressionCount = "SUCCESS_IMPRESSION";
